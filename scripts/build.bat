...
cmake -S %REPO_DIR% -B %SCPP_LOGGER_BUILD_DIR% -DCMAKE_BUILD_TYPE=%BUILD_TYPE% || exit /b
echo ----- SCPPLogger CMake configuration done -----

echo ----- Building SCPPLogger in %SCPP_LOGGER_BUILD_DIR% -----
cmake --build %SCPP_LOGGER_BUILD_DIR% --config %BUILD_TYPE% || exit /b
echo ----- SCPPLogger build done -----

echo ----- Installing SCPPLogger in %SCPP_LOGGER_BUILD_DIR% -----
cmake --install %SCPP_LOGGER_BUILD_DIR% --config %BUILD_TYPE% || exit /b
